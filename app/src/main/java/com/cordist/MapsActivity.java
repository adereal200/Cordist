...
//        // See https://g.co/AppIndexing/AndroidStudio for more information.
//        Action viewAction = newAction(
//                TYPE_VIEW, // TODO: choose an action type.
...
//                });
    ...
    public void onClick(View v) {
        if (v == buttonSetFrom) {
            ...
            Toast.makeText(this, "Starting point", Toast.LENGTH_SHORT).show();
        }

        if (v == buttonSetTo) {
            toLatitude = latitude;
            toLongitude = longitude;
            Toast.makeText(this, "End point", Toast.LENGTH_SHORT).show();
        }
        ...
        class SaveTask extends AsyncTask<Void, Void, Void> {
            ...
            protected Void doInBackground(Void... voids) {
               Coordinate coordinate =new Coordinate();
                ...
                coordinate.setFromLatitude(fromLatitude);
coordinate.setFromLongitude(fromLongitude);
coordinate.setToLatitude(toLatitude);
coordinate.setToLongitude(toLongitude);
            ...
            protected void onPostExecute(Void aVoid) {
               ...
               // startActivity(new Intent(getApplicationContext(), MainActivity.class));
                Toast.makeText(getApplicationContext(), "Saved lat& long", Toast.LENGTH_LONG).show();
            }
        }
